...
SECRET_KEY = 'django-insecure-bz1+2$&a8t4$vmc#c4_q6^1uyp#xwori3hhlrp#j+&9#+)f0g$'
...
DEFAULT_FILE_STORAGE = 'devsearch.storages.MediaStore'
...
#------------------ Load static files from local machine
